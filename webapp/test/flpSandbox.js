		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "invoicesapp",
									"targetURL": "#logaligroupinvoicestest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupinvoicestest-display": {
								"semanticObject": "logaligroupinvoicestest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.invoicestest",
									"url": sap.ui.require.toUrl("logaligroup/invoicestest")
								}
							}
						}
					}
